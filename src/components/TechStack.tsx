...
const TechStack = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const threshold = workSection.getBoundingClientRect().top + scrollY - 300;
    ...
    <div className="techstack">
      ...
      >
        ...
        <Physics gravity={[0, 0, 0]}>
          ...
          {spheres.map((props, i) => {
            const material = logoMaterials[i % logoMaterials.length];
            return (
              <SphereGeo
                key={i}
                {...props}
        ...
        <EffectComposer enableNormalPass={false}>
          <N8AO color="#220005" aoRadius={2} intensity={1.15} />
        </EffectComposer>
      </Canvas>
    </div>
  );
